 ...
 * @author ariel
 */
public class VentanaContrayentes extends javax.swing.JFrame {

    /**
     * Creates new form VentanaContrayentes
     */
    ...
    public VentanaContrayentes(ControladorContrayente controladorContrayente, JTextField nombre, JTextField cedula) {
        initComponents();
    ...
    public Contrayente getPersonaSeleccionada() {
        int filaIndex = jTablePersonas.getSelectedRow();
        Contrayente contrayente = controladorContrayente.buscar(new Contrayente(jTablePersonas.getValueAt(filaIndex, 2).toString()));
        return contrayente;
    }
    ...
    public void cargarDatosPersonas() {
        ...
        for (Contrayente contrayente : controladorContrayente.getListado()) {
            Object[] rowData = {contrayente.getNombre(), contrayente.getApellido(), contrayente.getCedula(), contrayente.getDireccion(), contrayente.getGenero(), contrayente.getEstadoCivil()};
    ...
    private void jButtonGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonGuardarActionPerformed
        ...
        if (jTextFieldCedula1.getText().trim().equals("") || jTextFieldNombre1.getText().trim().equals("") || jTextFieldApellido1.getText().trim().equals("")
            ...
            Contrayente p = new Contrayente(controladorContrayente.generarId(), jTextFieldNombre1.getText(), jTextFieldApellido1.getText()
            ...
            if (controladorContrayente.crear(p)) {
    ...
    private void jTablePersonasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTablePersonasMouseClicked
        // TODO add your handling code here:
        this.setVisible(false);
        Contrayente contrayente = getPersonaSeleccionada();
        nombre.setText(contrayente.getNombre() + " " + contrayente.getApellido());
        cedula.setText(contrayente.getCedula());
